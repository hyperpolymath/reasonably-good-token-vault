...
git clone
<https://github.com/hyperpolymath/reasonably-good-token-vault.git> cd
...
toolbox create reasonably-good-token-vault-dev toolbox enter
reasonably-good-token-vault-dev \# Install dependencies manually
...
reasonably-good-token-vault/ ├── src/ \# Source code (Perimeter 1-2) ├──
...
Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/reasonably-good-token-vault/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/reasonably-good-token-vault/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/reasonably-good-token-vault/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/reasonably-good-token-vault/labels/perimeter-3) — Community sandbox scope
