...
// Replace reasonably-good-token-vault, Reasonably Good Token Vault — See README.adoc for details., just run, Reasonably Good Token Vault started successfully. with actuals
= reasonably-good-token-vault — Quick Start for Users
:toc:
:toclevels: 2

== What is reasonably-good-token-vault?

Reasonably Good Token Vault — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./reasonably-good-token-vault-portable
----
...
[source]
----
Reasonably Good Token Vault started successfully.
----
