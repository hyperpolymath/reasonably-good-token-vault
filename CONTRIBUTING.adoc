...
= Contributing to Svalinn Vault
:toc:
:toclevels: 2

Thank you for your interest in contributing to Svalinn Vault. This document outlines our strict requirements for all contributions.
...
By contributing, you agree that your contributions will be licensed under the same license as the project (PMPL-1.0-or-later or MIT, at project maintainers' discretion).
